      ...
      >
        {posts.map((post) => (
          ...
          >
            ...
            <div className="pointer-events-none absolute inset-0 bg-gradient-to-t from-black/80 via-black/0 to-black/0 opacity-100 md:opacity-0 md:group-hover:opacity-100 transition-opacity duration-300">
              <div className="absolute bottom-0 left-0 right-0 p-3 sm:p-4">
                ...
                <a
                  ...
                  className="pointer-events-auto inline-flex items-center gap-1 sm:gap-2 text-white text-xs sm:text-sm hover:text-pink-300 transition-colors"
                >
                  ...
                  <span className="hidden sm:inline">{dict.home.instagram.viewOnInstagram}</span>
                  <span className="sm:hidden">{dict.home.instagram.viewOnInstagram}</span>
                </a>
              </div>
            </div>
          </div>
      ...
      {posts.length > 1 && (
        <>
          <button
            ...
            aria-label={dict.home.instagram.scrollLeft}
          >
          ...
          <button
            ...
            aria-label={dict.home.instagram.scrollRight}
          >
            <svg className="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24">
