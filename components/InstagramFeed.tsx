...
export default function InstagramFeed({ posts, dict }: InstagramFeedProps) {
  ...
  return (
    <div className="relative w-full max-w-6xl mx-auto">
      {/* Main Carousel */}
      <div className="relative h-[600px] md:h-[700px] overflow-hidden rounded-xl bg-gray-100 flex items-center justify-center">
        ...
        {/* Instagram Icon Overlay - Links to specific post */}
        <a
        ...
        {/* Caption Overlay - Only for videos since iframe covers it */}
        ...
        {posts.length > 1 && (
          <>
            <button
              ...
              aria-label={dict.home.instagram.previous}
            >
            ...
            <button
              ...
              aria-label={dict.home.instagram.next}
            >
              <svg className="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24">
